...
BASELINE(collapsed_gibbs, 100x100, 0, 1) {
...
BENCHMARK(collapsed_gibbs, 200x100, 0, 1) {
...
BENCHMARK(collapsed_gibbs, 300x100, 0, 1) {
...
BENCHMARK(collapsed_gibbs, 400x100, 0, 1) {
...
BENCHMARK(collapsed_gibbs, 100x200, 0, 1) {
...
BENCHMARK(collapsed_gibbs, 100x300, 0, 1) {
...
BENCHMARK(collapsed_gibbs, 100x400, 0, 1) {
